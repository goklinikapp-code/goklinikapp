      ...
      child: ListView(
        ...
        children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      if ((tenantBranding.logoUrl ?? '').isNotEmpty)
                        Container(
                          width: 32,
                          height: 32,
          ...
          GridView.count(
            ...
            children: [
              _QuickAction(
                  title: t('quick_schedule_appointment'),
                  icon: Icons.add_circle_outline,
                  onTap: () => context.push('/appointments/new/step1')),
              _QuickAction(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GKButton(
                          label: t('schedule'),
                          onPressed: () =>
                              context.push('/appointments/new/step1')),
                    ],
                  ),
                ),
              ],
